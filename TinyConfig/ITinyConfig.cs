namespace TinyConfig
{
    ...
    public interface ITinyConfig
    {
        ...
        /// <summary>Gets a typed value, converted via TypeConverter. Falls back to <paramref name="defaultValue"/>.</summary>
        T Get<T>(string section, string key, T defaultValue = default(T), bool autoSave = false);

        /// <summary>Gets a typed value. Returns false when the key is missing, empty, or does not match the type.</summary>
